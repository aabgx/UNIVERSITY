...
class NotaService:
    ...
    def asignare(self, ID, lab_prob, nota):
        ...
        lab = self.__repo_lab.cautare_lab_prob(lab_prob,0)
    ...
    def ordonare_alfabetica(self):
        ...
        lista_sortata_nume = QuickSort(lista_nume,0,len(lista_nume)-1,cmp = cmp_nume)
    ...
    def ordonare_nota(self):
        ...
        lista_sortata_note = QuickSort(lista_note,0,len(lista_note)-1)
    ...
    def ordonare_studenti_combinat(self):
        """
        Ordoneaza dupa criterii combinare(nume si grupa) studentii din repo.
        """
        lista = self.__repo_stud.get_all_students()
        QuickSort(lista,0,len(lista)-1,cmp = cmp_comb)
