...
public class UtilizatorController implements IObserver {
    ...
    public void setService(IServices service,String username) {
    ...
    public void setCasute() {
        try {
            ...
            try{
                list = service.creareVectorCnt();
            }catch(NullPointerException e){
                list = new ArrayList<>(Arrays.asList(15,4,7,3,3,2,3,3,4));
            }
        ...
        p_12_15.setText(list.get(8).toString());
            ...
            System.out.println("EXCEPTIE LA SET CASUTE"+e);
        }
...
//            }
    ...
    public void handleInscriere() throws Exception {
        ...
        !(desenRadio.isSelected() || cautareRadio.isSelected() || poezieRadio.isSelected())){
            ...
            service.adaugaCopilInscriere(numeField.getText().toString(), (Integer) varstaSpinner.getValue(), probe,username);
