...
public class TesteValidatori {
    ...
    public void testValidatorPrietenie(){
        ...
        Prietenie p2=new Prietenie("srfws","aefdqaw","");
        try{
            v.validate(p2);
            assertTrue(false);
        }catch(ValidationException e){
        ...
        Prietenie p3=new Prietenie("","erfvgew","erfwef");
        try{
            v.validate(p3);
            assertTrue(false);
        }catch(ValidationException e){
        ...
        Prietenie p4=new Prietenie("wfaewe","wevqwc","wfcwde");
        try{
            v.validate(p4);
            assertTrue(false);
        }catch(ValidationException e){
