...
public class PrietenieDBRepository implements Repository<String,Prietenie> {
    ...
    public List<Prietenie> getAll() {
        ...
        try (Connection connection = DriverManager.getConnection(url, username, password);
            ...
            while (resultSet.next()) {
                ...
                Prietenie user = new Prietenie(id, idPrieten1, idPrieten2, dateTime);
                prietenii.add(user);
            }
            return prietenii;
    ...
    public void adauga(Prietenie prietenie) {
        ...
        String sql = "insert into \"Friendships\" (id,idprieten1,idprieten2,data) values (?,?,?,?)";
    ...
    public void update(Prietenie prietenieVeche,Prietenie prietenieNoua){
        String sql = "update \"Friendships\" set idprieten1 = ?, idprieten2 = ?, data = ? where id = ?";
        try (Connection connection = DriverManager.getConnection(url, username, password);
             PreparedStatement ps = connection.prepareStatement(sql)) {
            ...
            ps.setString(3, data);
            ps.setString(4, prietenieVeche.getId());
