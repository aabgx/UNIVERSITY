...
public class Service {
    ...
    public void updatePrietenie(String Id,LocalDateTime data){
        Prietenie prietenie = PrietenieRepository.cautaId(Id);
        if(prietenie==null){
            throw new ValidationException("\nAceasta prietenie nu exista!\n");
        }
        Prietenie prietenieNoua=new Prietenie(Id,prietenie.getIdPrieten1(),prietenie.getIdPrieten2(),data);
        PrietenieRepository.update(prietenie,prietenieNoua);
    }
