...
public class UI {
    ...
    private void printeazaMeniu(){
        ...
        System.out.println("10. Update prietenie cu data si ora actuala\n");
    ...
    private void updatePrietenie(){
        ...
        Id=citire("Id prietenie: ");

        try{
            service.updatePrietenie(Id,data);
        }
        catch(ValidationException e){
            System.out.println("\u001B[31m"+e.getMessage()+"\u001B[0m");
        }
    ...
    private void adaugaPrietenie(){
        ...
        try{
            service.adaugaPrietenie(string1,string2,data);
        }
        catch(ValidationException e){
            System.out.println("\u001B[31m"+e.getMessage()+"\u001B[0m");
        }
