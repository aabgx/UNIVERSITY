...
void testSterge() {
	...
	printf("1.OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO\n");
	assert(c.dim() == 800);
	for (int i = -100; i < 100; i++) {
	...
	printf("2.OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO\n");
	assert(c.dim() == 0);
...
void testQuantity() {//scopul e sa adaugam multe date 
	...
	printf("5.OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO\n");
	assert(c.dim() == 175739);
	...
	printf("6.OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO\n");
	ic.prim();
	...
	printf("1 %d\n", c.dim());
	printf("7.OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO\n");
	assert(ic.valid() == false);
