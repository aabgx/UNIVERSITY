...
void ConsoleGUIProgram::update() {
	this->reloadActivityListFromProg(this->srv.get_all_program_srv());
}
...
//VECHI*********************************************
void ConsoleGUI::reloadActivityListFromProg(vector<Activitate> activities) {
	/*this->tableActivities->clearContents();
	this->tableActivities->setRowCount(activities.size());
...
void ConsoleGUI::initializeGUIComponents() {
	...
	////COMPONENTA DREAPTA DREAPTA
	//QWidget* stangastanga = new QWidget;
	//QVBoxLayout* lystangastanga = new QVBoxLayout;
	//stangastanga->setLayout(lystangastanga);
	//btn_add_program = new QPushButton("ADAUGA IN PROGRAM");
	//btn_add_random_program = new QPushButton("ADAUGA RANDOM IN PROGRAM");
	//btn_goleste_program = new QPushButton("GOLESTE PROGRAM");
	//lystangastanga->addWidget(btn_add_program);
	//lystangastanga->addWidget(btn_add_random_program);
	//lystangastanga->addWidget(btn_goleste_program);
	...
	lyFormleft->addRow(lblTitluP, editTitluP);
	btnAddProgram = new QPushButton("Adauga activitate in program");
