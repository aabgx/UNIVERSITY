...
VectorDinamic<Activitate> Repository::get_all() {
...
void Repository::sterge(Activitate a) {
	VectorDinamic<Activitate> lista = this->lista_activitati;
...
void test_adauga() {
	...
	VectorDinamic<Activitate> lista=repo.get_all();
	assert(lista.size() == 2);
